...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-screen flex-col items-center justify-center bg-black w-full z-0",
        className
      )}
    >
      <div className="relative flex w-full h-full items-center justify-center isolate z-0 pt-32">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[30rem] bg-gradient-conic from-white via-white/50 to-transparent text-white [--conic-position:from_70deg_at_center_top] top-0 overflow-visible"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-white/50 to-white text-white [--conic-position:from_290deg_at_center_top] top-0 overflow-visible"
        >
